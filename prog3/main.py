...
def main():
    ...
    supply1, demand1, costs1 = copy.deepcopy(supply), copy.deepcopy(demand), copy.deepcopy(costs)
    if sum(supply) == sum(demand) and len(supply) == 3 and len(demand) == 4:
        ...
        rus_x0, rus_ans = russells_approximation_method(supply1, demand1, costs1)
